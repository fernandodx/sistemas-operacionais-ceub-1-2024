...
public class Banheiro {
    ...
    public void fazerNumero1() {
        ...
        synchronized (this) {
            // Se o banheiro estiver sujo não
            while (this.isSujo) {
    ...
    public void limpar() {
        ...
        synchronized (this) {
            ...
            System.out.println("Iniciando limpeza do banheiro...");
            ...
            // Este avisa todas as threads que estavam no estado await
            // que ellas podem tentar novamente a sua execução.
            this.notifyAll();
        }
